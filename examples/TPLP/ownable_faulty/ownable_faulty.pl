...
% ownable_faulty.sol:ContractSimple contract
...
fun(obj_constructor_ContractSimple_128, [], [var(v0)], 'obj_constructor_ContractSimple_128_Block0_1').
fun(obj_constructor_Ownable_116, [], [], 'obj_constructor_Ownable_116_ret').
fun(obj_convert_t_uint160_to_t_uint256, [var(v0)], [var(v3), var(v2), var(v4)], 'obj_convert_t_uint160_to_t_uint256_Block0_1').
fun(obj_fun__initializeOwner_51, [var(v0)], [], 'obj_fun__initializeOwner_51_Block0_1').
fun(obj_fun__valid_address_40, [], [var(v7), var(v1), var(v4), var(v2), var(v6), var(v5)], 'obj_fun__valid_address_40_Block0_1').
...
fun(subO_abi_decode_t_bytes32, [var(v0), var(v1)], [var(v3)], 'subO_abi_decode_t_bytes32_Block0_1').
...
fun(subO_abi_decode_tuple_t_bytes32, [var(v0), var(v1)], [var(v4), var(v12), var(v5), var(v11)], 'subO_abi_decode_tuple_t_bytes32_Block0_1').
...
fun(subO_cleanup_t_bytes32, [var(v0)], [], 'subO_cleanup_t_bytes32_ret').
...
fun(subO_convert_t_uint160_to_t_uint256, [var(v0)], [var(v3), var(v2), var(v4)], 'subO_convert_t_uint160_to_t_uint256_Block0_1').
fun(subO_external_fun_owner_107, [], [var(v0), var(v1), var(v4), var(v6), var(v5), var(v3)], 'subO_external_fun_owner_107_Block0_1').
fun(subO_external_fun_transferOwnership_86, [], [var(v0), var(v4), var(v2), var(v5), var(v3)], 'subO_external_fun_transferOwnership_86_Block0_1').
fun(subO_external_fun_unsafeTransferOwnership_99, [], [var(v0), var(v4), var(v2), var(v5), var(v3)], 'subO_external_fun_unsafeTransferOwnership_99_Block0_1').
fun(subO_fun__checkOwner_68, [], [var(v3), var(v2), var(v4), var(v1)], 'subO_fun__checkOwner_68_Block0_1').
fun(subO_fun__setOwner_62, [var(v0)], [var(v2)], 'subO_fun__setOwner_62_Block0_1').
fun(subO_fun__valid_address_40, [], [var(v7), var(v1), var(v4), var(v2), var(v6), var(v5)], 'subO_fun__valid_address_40_Block0_1').
fun(subO_fun_owner_107, [], [var(v2), var(v1)], 'subO_fun_owner_107_Block0_1').
fun(subO_fun_transferOwnership_86, [var(v0)], [], 'subO_fun_transferOwnership_86_Block0_1').
fun(subO_fun_transferOwnership_86_inner, [var(v0)], [var(v3), var(v2)], 'subO_fun_transferOwnership_86_inner_Block0_1').
fun(subO_fun_unsafeTransferOwnership_99, [var(v0)], [], 'subO_fun_unsafeTransferOwnership_99_Block0_1').
fun(subO_fun_unsafeTransferOwnership_99_inner, [var(v0)], [var(v1)], 'subO_fun_unsafeTransferOwnership_99_inner_Block0_1').
fun(subO_identity, [var(v0)], [], 'subO_identity_ret').
fun(subO_modifier_onlyOwner_74, [var(v0)], [], 'subO_modifier_onlyOwner_74_Block0_1').
fun(subO_modifier_onlyOwner_91, [var(v0)], [], 'subO_modifier_onlyOwner_91_Block0_1').
...
fun(subO_validator_revert_t_bytes32, [var(v0)], [var(v3), var(v2), var(v1)], 'subO_validator_revert_t_bytes32_Block0_1').
fun(subO_zero_value_for_split_t_address, [], [], 'subO_zero_value_for_split_t_address_ret').
fun(subO_zero_value_for_split_t_bytes32, [], [], 'subO_zero_value_for_split_t_bytes32_ret').
...
at('obj_constructor_ContractSimple_128_Block0_1', fun_call(obj_constructor_Ownable_116, [], [])).
nextlab('obj_constructor_ContractSimple_128_Block0_1', 'obj_constructor_ContractSimple_128_Block0_2').
at('obj_constructor_ContractSimple_128_Block0_2', asgn(var(v0), expr(caller))).
nextlab('obj_constructor_ContractSimple_128_Block0_2', 'obj_constructor_ContractSimple_128_Block0_3').
at('obj_constructor_ContractSimple_128_Block0_3', fun_call(obj_fun__initializeOwner_51, [var(v0)], [])).
nextlab('obj_constructor_ContractSimple_128_Block0_3', 'obj_constructor_ContractSimple_128_ret').
at('obj_constructor_ContractSimple_128_ret', ret([])).
at('obj_constructor_Ownable_116_ret', ret([])).
...
at('subO_abi_decode_t_bytes32_Block0_1', asgn(var(v3), expr(calldataload([var(v0)])))).
nextlab('subO_abi_decode_t_bytes32_Block0_1', 'subO_abi_decode_t_bytes32_Block0_2').
at('subO_abi_decode_t_bytes32_Block0_2', fun_call(subO_validator_revert_t_bytes32, [var(v3)], [])).
nextlab('subO_abi_decode_t_bytes32_Block0_2', 'subO_abi_decode_t_bytes32_ret').
at('subO_abi_decode_t_bytes32_ret', ret([var(v3)])).
...
at('subO_abi_decode_tuple_t_bytes32_Block0_1', asgn(var(v4), expr(sub([var(v0), var(v1)])))).
nextlab('subO_abi_decode_tuple_t_bytes32_Block0_1', 'subO_abi_decode_tuple_t_bytes32_Block0_2').
at('subO_abi_decode_tuple_t_bytes32_Block0_2', asgn(var(v5), expr(slt([num(0x20), var(v4)])))).
nextlab('subO_abi_decode_tuple_t_bytes32_Block0_2', 'subO_abi_decode_tuple_t_bytes32_Block0_3').
at('subO_abi_decode_tuple_t_bytes32_Block0_3', cj(var(v5), 'subO_abi_decode_tuple_t_bytes32_Block2_1', 'subO_abi_decode_tuple_t_bytes32_Block1_1')).
at('subO_abi_decode_tuple_t_bytes32_Block2_1', asgn(var(v11), expr(add([num(0x00), var(v0)])))).
nextlab('subO_abi_decode_tuple_t_bytes32_Block2_1', 'subO_abi_decode_tuple_t_bytes32_Block2_2').
at('subO_abi_decode_tuple_t_bytes32_Block2_2', fun_call(subO_abi_decode_t_bytes32, [var(v1), var(v11)], [var(v12)])).
nextlab('subO_abi_decode_tuple_t_bytes32_Block2_2', 'subO_abi_decode_tuple_t_bytes32_ret').
at('subO_abi_decode_tuple_t_bytes32_ret', ret([var(v12)])).
at('subO_abi_decode_tuple_t_bytes32_Block1_1', fun_call(subO_revert_error_dbdddcbe895c83990c08b3492a0e83918d802a52331272ac6fdb6a7c4aea3b1b, [], [])).
...
at('subO_cleanup_t_bytes32_ret', ret([var(v0)])).
...
at('subO_external_fun_owner_107_Block0_1', asgn(var(v0), expr(callvalue))).
nextlab('subO_external_fun_owner_107_Block0_1', 'subO_external_fun_owner_107_Block0_2').
at('subO_external_fun_owner_107_Block0_2', cj(var(v0), 'subO_external_fun_owner_107_Block2_1', 'subO_external_fun_owner_107_Block1_1')).
at('subO_external_fun_owner_107_Block2_1', asgn(var(v1), expr(calldatasize))).
nextlab('subO_external_fun_owner_107_Block2_1', 'subO_external_fun_owner_107_Block2_2').
at('subO_external_fun_owner_107_Block2_2', fun_call(subO_abi_decode_tuple_, [var(v1), num(0x04)], [])).
nextlab('subO_external_fun_owner_107_Block2_2', 'subO_external_fun_owner_107_Block2_3').
at('subO_external_fun_owner_107_Block2_3', fun_call(subO_fun_owner_107, [], [var(v3)])).
nextlab('subO_external_fun_owner_107_Block2_3', 'subO_external_fun_owner_107_Block2_4').
at('subO_external_fun_owner_107_Block2_4', fun_call(subO_allocate_unbounded, [], [var(v4)])).
nextlab('subO_external_fun_owner_107_Block2_4', 'subO_external_fun_owner_107_Block2_5').
at('subO_external_fun_owner_107_Block2_5', fun_call(subO_abi_encode_tuple_t_address__to_t_address__fromStack, [var(v3), var(v4)], [var(v5)])).
nextlab('subO_external_fun_owner_107_Block2_5', 'subO_external_fun_owner_107_Block2_6').
at('subO_external_fun_owner_107_Block2_6', asgn(var(v6), expr(sub([var(v4), var(v5)])))).
nextlab('subO_external_fun_owner_107_Block2_6', 'subO_external_fun_owner_107_Block2_7').
at('subO_external_fun_owner_107_Block2_7', return([var(v6), var(v4)])).
at('subO_external_fun_owner_107_Block1_1', fun_call(subO_revert_error_ca66f745a3ce8ff40e2ccaf1ad45db7774001b90d25810abd9040049be7bf4bb, [], [])).
at('subO_external_fun_transferOwnership_86_Block0_1', asgn(var(v0), expr(calldatasize))).
nextlab('subO_external_fun_transferOwnership_86_Block0_1', 'subO_external_fun_transferOwnership_86_Block0_2').
at('subO_external_fun_transferOwnership_86_Block0_2', fun_call(subO_abi_decode_tuple_t_address, [var(v0), num(0x04)], [var(v2)])).
nextlab('subO_external_fun_transferOwnership_86_Block0_2', 'subO_external_fun_transferOwnership_86_Block0_3').
at('subO_external_fun_transferOwnership_86_Block0_3', fun_call(subO_fun_transferOwnership_86, [var(v2)], [])).
nextlab('subO_external_fun_transferOwnership_86_Block0_3', 'subO_external_fun_transferOwnership_86_Block0_4').
at('subO_external_fun_transferOwnership_86_Block0_4', fun_call(subO_allocate_unbounded, [], [var(v3)])).
nextlab('subO_external_fun_transferOwnership_86_Block0_4', 'subO_external_fun_transferOwnership_86_Block0_5').
at('subO_external_fun_transferOwnership_86_Block0_5', fun_call(subO_abi_encode_tuple__to__fromStack, [var(v3)], [var(v4)])).
nextlab('subO_external_fun_transferOwnership_86_Block0_5', 'subO_external_fun_transferOwnership_86_Block0_6').
at('subO_external_fun_transferOwnership_86_Block0_6', asgn(var(v5), expr(sub([var(v3), var(v4)])))).
nextlab('subO_external_fun_transferOwnership_86_Block0_6', 'subO_external_fun_transferOwnership_86_Block0_7').
at('subO_external_fun_transferOwnership_86_Block0_7', return([var(v5), var(v3)])).
at('subO_external_fun_unsafeTransferOwnership_99_Block0_1', asgn(var(v0), expr(calldatasize))).
nextlab('subO_external_fun_unsafeTransferOwnership_99_Block0_1', 'subO_external_fun_unsafeTransferOwnership_99_Block0_2').
at('subO_external_fun_unsafeTransferOwnership_99_Block0_2', fun_call(subO_abi_decode_tuple_t_bytes32, [var(v0), num(0x04)], [var(v2)])).
nextlab('subO_external_fun_unsafeTransferOwnership_99_Block0_2', 'subO_external_fun_unsafeTransferOwnership_99_Block0_3').
at('subO_external_fun_unsafeTransferOwnership_99_Block0_3', fun_call(subO_fun_unsafeTransferOwnership_99, [var(v2)], [])).
nextlab('subO_external_fun_unsafeTransferOwnership_99_Block0_3', 'subO_external_fun_unsafeTransferOwnership_99_Block0_4').
at('subO_external_fun_unsafeTransferOwnership_99_Block0_4', fun_call(subO_allocate_unbounded, [], [var(v3)])).
nextlab('subO_external_fun_unsafeTransferOwnership_99_Block0_4', 'subO_external_fun_unsafeTransferOwnership_99_Block0_5').
at('subO_external_fun_unsafeTransferOwnership_99_Block0_5', fun_call(subO_abi_encode_tuple__to__fromStack, [var(v3)], [var(v4)])).
nextlab('subO_external_fun_unsafeTransferOwnership_99_Block0_5', 'subO_external_fun_unsafeTransferOwnership_99_Block0_6').
at('subO_external_fun_unsafeTransferOwnership_99_Block0_6', asgn(var(v5), expr(sub([var(v3), var(v4)])))).
nextlab('subO_external_fun_unsafeTransferOwnership_99_Block0_6', 'subO_external_fun_unsafeTransferOwnership_99_Block0_7').
at('subO_external_fun_unsafeTransferOwnership_99_Block0_7', return([var(v5), var(v3)])).
...
at('subO_fun_owner_107_Block0_1', fun_call(subO_zero_value_for_split_t_address, [], [var(v1)])).
nextlab('subO_fun_owner_107_Block0_1', 'subO_fun_owner_107_Block0_2').
at('subO_fun_owner_107_Block0_2', asgn(var(v2), expr(sload([off(0x00)])))).
nextlab('subO_fun_owner_107_Block0_2', 'subO_fun_owner_107_ret').
at('subO_fun_owner_107_ret', ret([var(v2)])).
at('subO_fun_transferOwnership_86_Block0_1', fun_call(subO_modifier_onlyOwner_74, [var(v0)], [])).
nextlab('subO_fun_transferOwnership_86_Block0_1', 'subO_fun_transferOwnership_86_ret').
at('subO_fun_transferOwnership_86_ret', ret([])).
at('subO_fun_transferOwnership_86_inner_Block0_1', fun_call(subO_zero_value_for_split_t_bytes32, [], [var(v2)])).
nextlab('subO_fun_transferOwnership_86_inner_Block0_1', 'subO_fun_transferOwnership_86_inner_Block0_2').
at('subO_fun_transferOwnership_86_inner_Block0_2', asgn(var(v3), expr(iszero([var(v0)])))).
nextlab('subO_fun_transferOwnership_86_inner_Block0_2', 'subO_fun_transferOwnership_86_inner_Block0_3').
at('subO_fun_transferOwnership_86_inner_Block0_3', cj(var(v3), 'subO_fun_transferOwnership_86_inner_Block2_1', 'subO_fun_transferOwnership_86_inner_Block1_1')).
at('subO_fun_transferOwnership_86_inner_Block2_1', fun_call(subO_fun__setOwner_62, [var(v0)], [])).
nextlab('subO_fun_transferOwnership_86_inner_Block2_1', 'subO_fun_transferOwnership_86_inner_ret').
at('subO_fun_transferOwnership_86_inner_ret', ret([])).
at('subO_fun_transferOwnership_86_inner_Block1_1', mstore([num(0x7448fbae), mem(0x00)])).
nextlab('subO_fun_transferOwnership_86_inner_Block1_1', 'subO_fun_transferOwnership_86_inner_Block1_2').
at('subO_fun_transferOwnership_86_inner_Block1_2', revert([num(0x04), mem(0x1c)])).
at('subO_fun_unsafeTransferOwnership_99_Block0_1', fun_call(subO_modifier_onlyOwner_91, [var(v0)], [])).
nextlab('subO_fun_unsafeTransferOwnership_99_Block0_1', 'subO_fun_unsafeTransferOwnership_99_ret').
at('subO_fun_unsafeTransferOwnership_99_ret', ret([])).
at('subO_fun_unsafeTransferOwnership_99_inner_Block0_1', asgn(var(v1), expr(iszero([var(v0)])))).
nextlab('subO_fun_unsafeTransferOwnership_99_inner_Block0_1', 'subO_fun_unsafeTransferOwnership_99_inner_Block0_2').
at('subO_fun_unsafeTransferOwnership_99_inner_Block0_2', cj(var(v1), 'subO_fun_unsafeTransferOwnership_99_inner_Block2_1', 'subO_fun_unsafeTransferOwnership_99_inner_Block1_1')).
at('subO_fun_unsafeTransferOwnership_99_inner_Block2_1', fun_call(subO_fun__setOwner_62, [var(v0)], [])).
nextlab('subO_fun_unsafeTransferOwnership_99_inner_Block2_1', 'subO_fun_unsafeTransferOwnership_99_inner_ret').
at('subO_fun_unsafeTransferOwnership_99_inner_ret', ret([])).
at('subO_fun_unsafeTransferOwnership_99_inner_Block1_1', mstore([num(0x7448fbae), mem(0x00)])).
nextlab('subO_fun_unsafeTransferOwnership_99_inner_Block1_1', 'subO_fun_unsafeTransferOwnership_99_inner_Block1_2').
at('subO_fun_unsafeTransferOwnership_99_inner_Block1_2', revert([num(0x04), mem(0x1c)])).
...
at('subO_modifier_onlyOwner_74_Block0_2', fun_call(subO_fun_transferOwnership_86_inner, [var(v0)], [])).
nextlab('subO_modifier_onlyOwner_74_Block0_2', 'subO_modifier_onlyOwner_74_ret').
at('subO_modifier_onlyOwner_74_ret', ret([])).
at('subO_modifier_onlyOwner_91_Block0_1', fun_call(subO_fun__checkOwner_68, [], [])).
nextlab('subO_modifier_onlyOwner_91_Block0_1', 'subO_modifier_onlyOwner_91_Block0_2').
at('subO_modifier_onlyOwner_91_Block0_2', fun_call(subO_fun_unsafeTransferOwnership_99_inner, [var(v0)], [])).
nextlab('subO_modifier_onlyOwner_91_Block0_2', 'subO_modifier_onlyOwner_91_ret').
at('subO_modifier_onlyOwner_91_ret', ret([])).
...
at('subO_validator_revert_t_bytes32_Block0_1', fun_call(subO_cleanup_t_bytes32, [var(v0)], [var(v1)])).
nextlab('subO_validator_revert_t_bytes32_Block0_1', 'subO_validator_revert_t_bytes32_Block0_2').
at('subO_validator_revert_t_bytes32_Block0_2', asgn(var(v2), expr(eq([var(v1), var(v0)])))).
nextlab('subO_validator_revert_t_bytes32_Block0_2', 'subO_validator_revert_t_bytes32_Block0_3').
at('subO_validator_revert_t_bytes32_Block0_3', asgn(var(v3), expr(iszero([var(v2)])))).
nextlab('subO_validator_revert_t_bytes32_Block0_3', 'subO_validator_revert_t_bytes32_Block0_4').
at('subO_validator_revert_t_bytes32_Block0_4', cj(var(v3), 'subO_validator_revert_t_bytes32_ret', 'subO_validator_revert_t_bytes32_Block1_1')).
at('subO_validator_revert_t_bytes32_ret', ret([])).
at('subO_validator_revert_t_bytes32_Block1_1', revert([num(0x00), mem(0x00)])).
at('subO_zero_value_for_split_t_address_ret', ret([num(0x00)])).
at('subO_zero_value_for_split_t_bytes32_ret', ret([num(0x00)])).
...
at('runtime_contract', fun_call(r_ContractSimple_128_deployed, [], [])).
...
at('init_contract_Block2_1', fun_call(obj_constructor_ContractSimple_128, [], [])).
...
at('ContractSimple_128_deployed_Block0_1', mstore([num(0x80), mem(0x40)])).
nextlab('ContractSimple_128_deployed_Block0_1', 'ContractSimple_128_deployed_Block0_2').
at('ContractSimple_128_deployed_Block0_2', asgn(var(v3), expr(calldatasize))).
nextlab('ContractSimple_128_deployed_Block0_2', 'ContractSimple_128_deployed_Block0_3').
at('ContractSimple_128_deployed_Block0_3', asgn(var(v4), expr(lt([num(0x04), var(v3)])))).
nextlab('ContractSimple_128_deployed_Block0_3', 'ContractSimple_128_deployed_Block0_4').
at('ContractSimple_128_deployed_Block0_4', asgn(var(v5), expr(iszero([var(v4)])))).
nextlab('ContractSimple_128_deployed_Block0_4', 'ContractSimple_128_deployed_Block0_5').
at('ContractSimple_128_deployed_Block0_5', cj(var(v5), 'ContractSimple_128_deployed_Block2_1', 'ContractSimple_128_deployed_Block1_1')).
at('ContractSimple_128_deployed_Block2_1', fun_call(subO_revert_error_42b3090547df1d2001c96683413b8cf91c1b902ef5e3cb8d9f6f304cf7446f74, [], [])).
at('ContractSimple_128_deployed_Block1_1', asgn(var(v7), expr(calldataload([num(0x00)])))).
nextlab('ContractSimple_128_deployed_Block1_1', 'ContractSimple_128_deployed_Block1_2').
at('ContractSimple_128_deployed_Block1_2', fun_call(subO_shift_right_224_unsigned, [var(v7)], [var(v8)])).
nextlab('ContractSimple_128_deployed_Block1_2', 'ContractSimple_128_deployed_Block1_3').
at('ContractSimple_128_deployed_Block1_3', asgn(var(v9), expr(eq([num(0x2fe6eb89), var(v8)])))).
nextlab('ContractSimple_128_deployed_Block1_3', 'ContractSimple_128_deployed_Block1_4').
at('ContractSimple_128_deployed_Block1_4', cj(var(v9), 'ContractSimple_128_deployed_Block5_1', 'ContractSimple_128_deployed_Block4_1')).
at('ContractSimple_128_deployed_Block5_1', asgn(var(v11), expr(eq([num(0x8da5cb5b), var(v8)])))).
nextlab('ContractSimple_128_deployed_Block5_1', 'ContractSimple_128_deployed_Block5_2').
at('ContractSimple_128_deployed_Block5_2', cj(var(v11), 'ContractSimple_128_deployed_Block8_1', 'ContractSimple_128_deployed_Block7_1')).
at('ContractSimple_128_deployed_Block4_1', fun_call(subO_external_fun_unsafeTransferOwnership_99, [], [])).
at('ContractSimple_128_deployed_Block8_1', asgn(var(v13), expr(eq([num(0xf2fde38b), var(v8)])))).
nextlab('ContractSimple_128_deployed_Block8_1', 'ContractSimple_128_deployed_Block8_2').
at('ContractSimple_128_deployed_Block8_2', cj(var(v13), 'ContractSimple_128_deployed_Block11_1', 'ContractSimple_128_deployed_Block10_1')).
at('ContractSimple_128_deployed_Block7_1', fun_call(subO_external_fun_owner_107, [], [])).
at('ContractSimple_128_deployed_Block11_1', goto('ContractSimple_128_deployed_Block3_1')).
